...
class FlexBoxAlignSelf{
     ...
     */
    static func flexStart(_ item:FlexBoxItemKind, _ container:CGRect){
     ...
     */
    static func flexEnd(_ item:FlexBoxItemKind, _ container:CGRect){
     ...
     */
    static func center(_ item:FlexBoxItemKind, _ container:CGRect){
     ...
     */
    static func stretch(_ item:FlexBoxItemKind, _ container:CGRect){
        item.flexible.y = Align.alignmentPoint(item.flexible.size, container.size, Alignment.topCenter, Alignment.topCenter,container.topLeft).y
