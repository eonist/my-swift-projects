...
class CGAffineTransformModifier {
     ...
     */
    static func transformWithPivot(inout transform:CGAffineTransform, _ scale:CGPoint, _ rotation:CGFloat, _ offset:CGPoint, _ pivot:CGPoint,_ initRotation:CGFloat = 0) -> CGAffineTransform {
     ...
     */
    static func transformPoint(point:CGPoint, _ transform:CGAffineTransform) -> CGPoint{
