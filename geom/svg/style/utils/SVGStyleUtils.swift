...
class SVGStyleUtils {
     ...
     */
    static func lineCap(lineCap:String?)->CGLineCap{
     ...
     *
     */
    static func lineJoin(lineJoin:String?)->CGLineJoin{
     ...
     *
     */
    static func miterLimit(miterLimit:CGFloat)->CGFloat{
        return !miterLimit.isNaN ? miterLimit : 10/*<--was 1.414*/;
    }
    /**
     *
     */
    static func strokeWidth(strokeWidth:CGFloat)->CGFloat{
        return !(strokeWidth.isNaN) ? strokeWidth : 0
    }
    /**
     *
     */
    static func strokeColor(strokeColor:Double,_ strokeOpacity:CGFloat)->NSColor{
        /*color*/
     ...
     */
    static func boundingBox(path:CGPath,_ style:SVGStyle)->CGRect{
     ...
     * New
     */
    static func graphicStyle(svgGraphic:ISVGGraphic)->IGraphicStyle{
