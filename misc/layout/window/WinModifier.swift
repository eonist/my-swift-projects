...
class WinModifier {
     ...
     */
    static func position(win:NSWindow, _ position:CGPoint){
     ...
     */
    static func align(win:NSWindow,_ canvasAlignment:String,_ viewAlignment:String,_ offset:CGPoint = CGPoint(0,0)) {
     ...
     */
    static func alignPoint(winSize:CGSize,_ canvasAlignment:String,_ viewAlignment:String,_ offset:CGPoint = CGPoint(0,0))->CGPoint{
