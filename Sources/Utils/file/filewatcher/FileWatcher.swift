...
class FileWatcher{
     ...
     */
    typealias EventCallBack = (stream:ConstFSEventStreamRef,contextInfo:UnsafeMutableRawPointer?,numEvents:Int,eventPaths:UnsafeMutableRawPointer,eventFlags:UnsafePointer<FSEventStreamEventFlags>?,eventIds:UnsafePointer<FSEventStreamEventId>?)
    private let eventCallback:FSEventStreamCallback = { eventCallBack in
