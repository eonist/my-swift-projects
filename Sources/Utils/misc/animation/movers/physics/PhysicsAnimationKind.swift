...
protocol PhysicsAnimationKind:class{
    ...
    /*Event related*/
    var callBack:FrameTickSignature {get set}/*The closure method that is called on every "frame-tick" and changes the property, you can use a var closure or a regular method, probably even an inline closure*/
    /*Core Methods*/
