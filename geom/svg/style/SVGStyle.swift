...
class SVGStyle {
    ...
    var stroke : Double/*TODO: Stroke needs to be of type Any? since it needs to support gradient stroke aswell*/
    var strokeOpacity : CGFloat
    var strokeLineCap : String?
    var strokeLineJoin : String?
    var strokeMiterLimit : CGFloat
    init(_ fill:Any? = CGFloat.NaN,_ fillOpacity:CGFloat = CGFloat.NaN,_ fillRule:String? = nil,_ strokeWidth:CGFloat = CGFloat.NaN,_ stroke:Double = Double.NaN ,_ strokeOpacity:CGFloat = CGFloat.NaN,_ strokeLineCap:String? = nil,_ strokeLineJoin:String? = nil, _ strokeMiterLimit:CGFloat = CGFloat.NaN) {
        self.fill = fill;
