...
extension Colors{
    ...
    static func fancyColors() -> Array<(name:String,color:NSColor)> {return [("red",red()),("orange",orange()),("yellow",yellow())]}//,,,green(),lightBlue(),darkBlue(),purple(),pink(),darkGray(),lightGray()
}