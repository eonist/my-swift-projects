...
//        return AnimState5<CGPoint>(value: CGPoint(0,0), targetValue: CGPoint(0,0), velocity: CGPoint(0,0), stopVelocity: CGPoint(0,0))
//    }
//    static func initValues() ->  AnimState5<CGFloat>  {
//        return AnimState5<CGPoint>.init(value: 0, targetValue: 0, velocity: 0, stopVelocity: 0)
//    }
