...
class CGAffineTransformParser {
     ...
     */
    static func transformWithPivot(_ transform:CGAffineTransform, _ scale:CGPoint, _ rotation:CGFloat, _ offset:CGPoint, _ pivot:CGPoint,_ initRotation:CGFloat = 0) -> CGAffineTransform {
     ...
     */
    static func rotateAroundPoint(_ transform:CGAffineTransform,_ rotation:CGFloat,_ pivot:CGPoint)->CGAffineTransform{
        var transform = transform
     ...
     */
    static func scaleFromPoint(_ transform:CGAffineTransform, _ xScale:CGFloat,_ yScale:CGFloat,_ pivot:CGPoint)->CGAffineTransform{
        var transform = transform
     ...
     *
     */
    static func translate(_ transform:CGAffineTransform,_ x:CGFloat,_ y:CGFloat)->CGAffineTransform{
        var transform = transform
     ...
     */
    static func transformAroundPoint(_ transform:CGAffineTransform, _ scale:CGPoint, _ rotation:CGFloat, _ offset:CGPoint, _ pivot:CGPoint)->CGAffineTransform{
        var transform = transform
    ...
    static func copy(_ transform:CGAffineTransform)->CGAffineTransform{
    ...
    static func concat(_ a:CGAffineTransform,_ b:CGAffineTransform)->CGAffineTransform{
