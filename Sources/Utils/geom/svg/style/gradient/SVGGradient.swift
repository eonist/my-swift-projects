...
class SVGGradient:SVGElement,ISVGGradient{
    ...
    init(_ offsets:[CGFloat],_ colors:[CGColor],/*_ opacities:Array<CGFloat>,*/_ spreadMethod:String,_ id:String,_ gradientUnits:String,_ gradientTransform:CGAffineTransform? = nil/**/) {
