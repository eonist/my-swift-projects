...
public class Gradient:IGradient{
    ...
    public var relativeStartRadius:CGSize?//0 to 1 (x:0.5 means half the size of the current cross-section in the x-axis) the x-axis is determined by the rotation (this value can also be anything above 1, think 120% of the original)
