...
class Shape : CALayer{
    ...
    */
    ...
    override init(){
        ...
        self.autoresizingMask = [.LayerWidthSizable, .LayerHeightSizable]//CAAutoresizingMask
            //NSAutoresizingMaskOptions.NSViewWidthSizable.union(NSAutoresizingMaskOptions.NSViewHeightSizable)
