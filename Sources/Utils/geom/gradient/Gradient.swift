 ...
 * EXAMPLE: let gradie  nt:Gradient = Gradient([NSColor.blueColor().CGColor,NSColor.redColor().CGColor])
 ...
 * TODO: ⚠️️ Find that medium article on axial gradient. the one that looks like a "spread out patonefan"
 */
