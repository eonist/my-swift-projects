...
private class Utils{
    ...
    class func drawAxialGradient(path:CGPath,_ context:CGContextRef,_ cgGradient:CGGradientRef?, _ boundingBox:CGRect, _ gradient:IGradient){
        ...
        let points = GradientBoxUtils.points(boundingBox, gradient.rotation)//gradient.p1 != nil && gradient.p2 != nil ? GradientBoxUtils.points(boundingBox, gradient.rotation) : (start:gradient.p1!,end:gradient.p2!)/*GradientBox*/
