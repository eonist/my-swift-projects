...
class SVGGraphicModifier {
    ...
    class func beginGradientFill(shape:Shape,_ gradient:SVGGradient) {
        ...
        if(gradient is SVGLinearGradient){
            ...
            var p1:CGPoint = /*userSpaceOnUse && !gradient.x1.isNaN && !gradient.y1.isNaN ? */CGPoint((gradient as! SVGLinearGradient).x1,(gradient as! SVGLinearGradient).y1)/* :nil*/
            var p2:CGPoint = /*userSpaceOnUse && !gradient.x2.isNaN && !gradient.y2.isNaN ? */CGPoint((gradient as! SVGLinearGradient).x2,(gradient as! SVGLinearGradient).y2)/* :nil*/
            ...
            graphics.gradientFill(gradient as! SVGLinearGradient)
        }
    }
}
private class Utils{
