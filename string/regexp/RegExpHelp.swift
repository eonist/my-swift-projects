...
n or more.
{n,}?
At least n times, but no more than required for an overall pattern match.
{n,m}
Between n and m times.
{n,m}?
Between n and m times. Match as few times as possible, but not less than n.
...
End of a line.
\A
Beginning of an input. Doesn’t match after a new line within the input.
\z
End of input.
\Z
End of input, but before the final line terminator, if one exists.
.
Any character.
\
