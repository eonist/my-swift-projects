...
protocol PhysicsAnimationKind {
    ...
    /*Event related*/
    var callBack:Springer<argType>.FrameTick {get set}/*The closure method that is called on every "frame-tick" and changes the property, you can use a var closure or a regular method, probably even an inline closure*/
