...
extension TextFormat{
    ...
    func attributedStringValue(stringValue:String) -> NSAttributedString{
        ...
        textParagraph.lineSpacing = -5//self.leading/*this sets the space BETWEEN lines to 10points*/
        textParagraph.alignment = TextFieldParser.alignment(self.align)//Left,Right,Justified,Natural,Center
        //textParagraph.maximumLineHeight = 0.0/*this sets the MAXIMUM height of the lines to 12points*/
        //textParagraph.minimumLineHeight = 0.0
