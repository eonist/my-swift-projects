...
class Spring<T:NumberKind>:BaseAnimation {
    ...
    init(_ animatable:Animatable, _ callBack:@escaping FrameTick, config:(spring:T, friction:T)/* = (spring:0.02,friction:0.90)*/, initVals:(value:T,targetValue:T,velocity:T)) {
