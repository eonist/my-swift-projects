...
class SVGPathDataParser {
	 ...
	 */
	static func pathData(_ path:SVGPath, _ index:Int)->Array<CGFloat> {
	 ...
	 */
	static func index(_ commands:Array<String>,_ commandIndex:Int)->Int {
		var pathDataIndex:Int = 0
        for i in 0..<commandIndex{
            pathDataIndex += SVGCommandParser.commandLength(commands[i])
        }
