...
class NumberAsserter{
     ...
     *
     */
    static func even(number:CGFloat)->Bool{
        return !odd(number)
    }
    /**
     * NOTE: In most cases you will want to write if(someNumber < 0)
     */
    static func negative(number:CGFloat)->Bool {
        return number < 0
    }
    /**
     * NOTE: In most cases you will want to write if(someNumber >
     */
    static func positive(number:CGFloat)->Bool {
        return number > 0
    }
    /**
     ...
     */
    static func isNear(a:CGFloat,_ b:CGFloat,_ epsilon:CGFloat)->Bool {//this could also be named almostEqual
        if(a == b){ return true}
        else{
     ...
     */
    static func near(a:CGFloat,_ b:CGFloat,_ epsilon:CGFloat) -> Bool{
     ...
     */
    static func isInfinity(number:CGFloat) -> Bool {
