...
class RangeParser {
     ...
     */
    static func min<T:Comparable>(range:Range<T>)->T {
        return Swift.min(range.start, range.end);
    }
    /**
     *
     */
    static func describe<T>(range:Range<T>) {
     ...
     */
    static func max<T:Comparable>(range:Range<T>)->T {
        return Swift.max(range.start, range.end);
    }
    /**
     * Returns a clone of the PARAM: range instance
     */
    static func clone<T>(range:Range<T>) -> Range<T> {
        return Range(range.start, range.end)
    }
    /**
     * NOTE: only works with Range<Int>
     */
    static func difference(range:Range<Int>) -> Int{
     ...
     */
    static func numOfIndecies(range:Range<Int>) -> Int{
