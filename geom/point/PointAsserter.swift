...
class PointAsserter {
     ...
     */
    static func less(p1:CGPoint, p2:CGPoint) -> Bool {
...
static func more(p1:CGPoint, p2:CGPoint) -> Bool {
     ...
     */
    static func oppositeDirectional(bisectorP1:CGPoint,_ bisectorP2:CGPoint,_ aP1:CGPoint,_ aP2:CGPoint,_ bP1:CGPoint,_ bP2:CGPoint) -> Bool {
     ...
     */
    static func intersects(a1:CGPoint ,  _ a2:CGPoint,  _ b1:CGPoint,  _ b2:CGPoint) -> Bool {
     ...
     */
    static func nearEquals(a:CGPoint, _ b:CGPoint, _ epsilon:CGFloat) -> Bool{
     ...
     */
    static func isContraDirectional(aP1:CGPoint,_ aP2:CGPoint,_ bP1:CGPoint,_ bP2:CGPoint) -> Bool {
