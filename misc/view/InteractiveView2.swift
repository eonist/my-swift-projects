...
class InteractiveView2:FlippedView,IInteractiveView{
    ...
    override func mouseUp(theEvent: NSEvent) {
        ...
        mouseUp(MouseEvent(theEvent,self))/*<--The mouseUp call was moved above the upInside/upOutSide calls because there was a bug when having it bellow the 2 calls*/
    }
    /**
