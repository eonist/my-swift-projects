...
class SVGGraphicModifier {
     ...
     */
    static func applyStrokeStyle(graphics:Graphics, _ style:SVGStyle){
     ...
     */
    static func applyGradientStrokeStyle(shape:Shape,_ style:SVGStyle){
     ...
     */
    static func beginGradientFill(shape:Shape,_ gradient:SVGGradient){
