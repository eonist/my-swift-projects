import Foundation
class Path:IPath {
    var commands:[Int]/* = Array<Int>();*/// :TODO: does this need to be created? isnt it passed through argument
    var pathData:[CGFloat]/* = Array<CGFloat>();*/// :TODO: does this need to be created? isnt it passed through argument
