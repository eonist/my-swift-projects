...
extension Array {
    ...
    */
     ...
     * Convenience method
     */
    mutating func shiftAppend(_ item: Element) -> [Element] {
        return ArrayModifier.shiftAppend(&self, item)
    }
    /**
     * Convenience method
     */
    mutating func displace( _ from: Int, _ to: Int) -> [Element] {
        return ArrayModifier.displace(&self, from, to)
    }
    /**
     * Convenience method
     */
    mutating func insertAt(_ item:Element, _ index:Int) -> [Element] {
...
extension Array {
     ...
     * NOTE: If you need a mutating concatination behaviour use the += operator
     */
    func concat(_ item: Element) -> [Element] {
        return concat([item])
    }
    /**
