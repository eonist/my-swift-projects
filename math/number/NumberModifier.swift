...
class NumberModifier{
     ...
     */
    static func swap(inout a:Double, inout _ b:Double) {
     ...
     */
    static func increment(number:CGFloat,_ incrementation:CGFloat) -> CGFloat {
     ...
     * NOTE: The multiplication and division is a floating bug fix, optimized by looking at how many decimal points the PARAM: number has
     */
    static func decrement(number:CGFloat,_ decrementation:CGFloat)->CGFloat {
     ...
     */
    static func toFixed(value:CGFloat, _ places:Int) -> CGFloat {
     ...
     */
    static func roundTo(number:CGFloat, _ closest:CGFloat) -> CGFloat {
